...
public class QuestionBuyingRvAdapter extends RecyclerView.Adapter<QuestionBuyingRvAdapter.ViewHolder> {
    public ArrayList<QuestionFragmentRvItem> questionFragmentRvItemArrayList;

    public QuestionBuyingRvAdapter(ArrayList<QuestionFragmentRvItem> questionFragmentRvItemArrayList) {
